...
// Version: 1.0.0
// Date: 2025-08-16
// Changes: Initial creation of the dedicated screen for adding a new measurement.
...
export default function AddMeasurementScreen() {
  ...
  const handleSave = () => {
      console.log('SAVE', { readingDate, glucose: glucoseNumber, measurementType, notes, selectedMeals, exerciseDate, selectedExercises, duration });
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.navRow}>
          ...
          {step < 2 ? (
            ...
            <Pressable style={[styles.saveBtn, { backgroundColor: themeColors.tint }, !glucoseValid && styles.navBtnDisabled]} disabled={!glucoseValid} onPress={handleSave}>
...
const styles = StyleSheet.create({
    ...
    stepHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12, paddingTop: 12 },
